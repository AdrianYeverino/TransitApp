...
class ImageQuizGame extends StatefulWidget {
  ...
  const ImageQuizGame({super.key, required this.question, required this.onAnswered});
...
class _ImageQuizGameState extends State<ImageQuizGame> {
          ...
          Container(
            ...
            child: ClipRRect(
              ...
              child: Image.network(
                ...
                fit: BoxFit.contain,
                errorBuilder: (context, error, stackTrace) => const Icon(Icons.broken_image_rounded, size: 50, color: Colors.grey),
              ),
            ),
          ),
  ...
  // (El _buildOptionCard se queda igual al que ya tenías)
