      ...
      body: authUser == null
          ...
          : StreamBuilder<DocumentSnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                int modulosCompletados = completadas
                    .where((id) => id.contains('examen'))
                    .length;
                ...
                DateTime fechaUltima =
                    authUser.metadata.lastSignInTime ?? DateTime.now();
                String fechaUltimaStr =
                    "${fechaUltima.day}/${fechaUltima.month}/${fechaUltima.year}";

                // Cálculo para el próximo nivel (ej. cada 500 XP)
                int metaXp = ((xp ~/ 500) + 1) * 500;
                double progresoNivelXp = (xp % 500) / 500;
                final List<String> logrosUsuario = List<String>.from(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildProgressBar(
                              ...
                              '$totalLeccionesCompletadas completadas',
                              totalLeccionesCompletadas > 0 ? 1.0 : 0.0,
                            ),
                            const SizedBox(height: 20),
                            _buildProgressBar(
                              'Próximo nivel en:',
                      ...
                      _buildCardContainer(
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildInfoText(
                              'Lecciones en total',
                              '$totalLeccionesCompletadas lecciones',
                            ),
                          ],
                        ),
                      ),
                            ...
                            StreamBuilder<DocumentSnapshot>(
                              ...
                              builder: (context, logroSnap) {
                                ...
                                final List<dynamic> listaRaw =
                                    raw['lista_logros'] ?? [];
                                final List<LogroModel> logrosDisponibles =
                                    listaRaw
                                ...
                                final int previewCount =
                                    logrosDisponibles.length <= 3
                                    ? logrosDisponibles.length
                                    : 3;
                                final preview = logrosDisponibles
                                    .take(previewCount)
                                    .toList();
                                ...
                                return Column(
                                  children: [
                                    ...preview.map(
                                      (l) => _buildLogroItem(
                                        logro: l,
                                        estaDesbloqueado: logrosUsuario
                                            .contains(l.id),
                                      ),
                                    ),
