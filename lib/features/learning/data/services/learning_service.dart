...
class LearningService {
  ...
  Future<void> actualizarProgresoAlGanar({
    ...
    try {
      ...
      // Actualizamos el diccionario interno de progreso del mundo actual con notación de punto
      // Esto permite usar FieldValue.increment() en campos anidados
      ...
      // 5. Verificar Logros es manejado por LogrosService.verificarYDesbloquearLogro() 
      // que se llama desde quiz_page.dart después de actualizar progreso
      // Anteriormente se llamaba aquí, pero ahora se hace en el flujo del quiz para mayor control
    } catch (e) {
      print("❌ Error en motor de progreso: $e");
    }
  }

  // --- MOTOR DE LOGROS GLOBALES (DEPRECATED) ---
  // Este método fue reemplazado por LogrosService.verificarYDesbloquearLogro()
  // que tiene lógica más robusta y es llamado desde quiz_page.dart
  /*
